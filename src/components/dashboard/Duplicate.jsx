...
const Duplicate = () => {
    ...
    const fetchFormData = async () => {
      ...
      try {
        ...
        if (Array.isArray(data) && data.length > 0) {
          ...
          setFormData((prev) => ({
            ...prev,
            ref_name: formDataFromApi.ref_name,
            ref_name2: formDataFromApi.ref_name2,
            ref_name3: formDataFromApi.ref_name3,
            ref_name4: formDataFromApi.ref_name4,
  ...
  const handleSubmit = async (e) => {
    ...
    // Append carriers as JSON string
    formDataToSend.append("carriers", JSON.stringify(normalizedCarriers));
